...
export const TeachersTimetable = () => {
  return (
    <section
      className={`${styles.students_Container} bg-[#f4f4f4] h-full overflow-auto w-full`}
    >
      <div
        className={`${styles.timetable_header} px-[4rem] py-[1rem] flex items-center box-border`}
      >
