...
export const SelectStudent = () => {
  return (
    <section className="bg-[#D0D4E7] w-full h-full sm:pb-8 overflow-auto">
      <main className="pb-8">
        ...
        <div className="sm:flex sm:justify-center sm:gap-10 pt-16 grid grid-cols-2 place-items-center">
          <figure className="bg-[#f4f4f4] w-32 sm:w-[312px] h-32 sm:h-[374px] flex justify-center items-center rounded-2xl">
            <img
          ...
          <Link to={"/students/dashboard"}>
            <figure className="bg-[#f4f4f4] w-32 h-32 sm:w-[312px] sm:h-[374px] flex justify-center items-center rounded-2xl ">
              <img
