...
export const CustomInput = ({ label, required = false, capitalize = true, optionalMessage = "", ...props }) => {
  ...
  const handleChange = (event) => {
    const value = props.name === 'email' ? event.target.value : capitalize ? capitalizeFirstLetter(event.target.value) : event.target.value;
